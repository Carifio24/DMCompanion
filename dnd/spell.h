...
class Spell {
    ...
    public:
        ...
        // Default constructor
        Spell() : Spell("", "", "", 0, Distance(), std::array<bool,3>(), "", false, Duration(), false, "", 0, Schools::Abjuration, std::vector<CasterClass>(), Sourcebooks::PlayersHandbook) {}
    ...
    private:
        ...
        int _level;
        School _school;
        std::vector<CasterClass> _classes;
